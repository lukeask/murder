...
from murder.persistence.schema import get_db as _db_connect, init_db as _db_init_schema
from murder.persistence.runs import insert_run as _db_insert_run, end_run as _db_end_run
from murder.persistence.agents import upsert_agent as _db_upsert_agent, set_agent_status as _db_set_agent_status
...
from murder.service.runtime_lifecycle import shutdown_live_agents
...
if TYPE_CHECKING:
    ...
    from murder.tickets.sidecar_sync import TicketMetadataSync
