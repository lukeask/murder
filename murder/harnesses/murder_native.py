...
class MurderNativeAdapter(HarnessAdapter):
    ...
    def startup_cmd(self, cwd: Path) -> list[str]:
        ...
        raise NotImplementedError("v2: murder_native startup_cmd")

    def is_ready(self, pane_text: str) -> bool:
        # Native agents will signal readiness via the bus, not the pane.
        raise NotImplementedError("v2: murder_native is_ready (bus side-channel)")

    def is_idle(self, pane_text: str) -> bool:
        raise NotImplementedError("v2: murder_native is_idle (bus side-channel)")

    def is_busy(self, pane_text: str) -> bool:
        raise NotImplementedError("v2: murder_native is_busy (bus side-channel)")

    def extract_last_message(self, pane_text: str) -> str | None:
        raise NotImplementedError("v2: murder_native extract_last_message")
