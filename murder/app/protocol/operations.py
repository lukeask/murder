...
_COMMAND_MODELS: dict[CommandName, tuple[type[BaseModel], type[BaseModel], bool]] = {
    ...
    CommandName.REPORT_CREATE: (ReportCreateParams, ReportCreateResult, False),
    ...
    CommandName.WORKFLOW_PUT: (PutWorkflowParams, PutWorkflowResult, False),
    CommandName.WORKFLOW_DELETE: (DeleteWorkflowParams, DeleteWorkflowResult, False),
