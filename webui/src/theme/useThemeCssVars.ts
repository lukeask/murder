 ...
 *
 * The shared theme store is the same singleton the Ink UI uses, so a future
...
import { useTheme, useThemeId } from '@murder/ui-core/theme/themeStore.js';
import { getThemeMeta } from '@murder/ui-core/theme/palettes.js';
...
export function useThemeCssVars(): void {
  ...
  // DS light/dark switch by reflecting the active shared scheme onto `<html data-theme>`. The DS
