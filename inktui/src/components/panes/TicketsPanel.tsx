/**
 * TicketsPanel — store-free, dimension-driven tickets list (2-row × up-to-5-column layout).
 *
 ...
 * {@link ../TicketsPanel.tsx} multi-column Ledger layout at large sizes.
 */
...
export interface TicketsPanelRow {
  readonly id: string;
...
export interface TicketsPanelProps {
  ...
  readonly rows: readonly TicketsPanelRow[];
...
export const TicketsPanel = memo(function TicketsPanel({
  ...
  status = 'ready',
  error = null,
}: TicketsPanelProps): React.JSX.Element {
