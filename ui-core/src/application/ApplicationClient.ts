...
/** Application-client capability used by application entrypoints and connection indicators. */
export interface ApplicationConnectionClient extends ApplicationClient {
