...
import { SPAN_CLOSE, SPAN_OPEN } from '@murder/ui-core/input/chatInputStore.js';
import { reduceVimNormal, type VimEffect } from '@murder/ui-core/input/chatVimReducer.js';
