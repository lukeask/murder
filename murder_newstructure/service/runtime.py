...
from murder_newstructure.service.recovery import reconcile_agents_vs_tmux
from murder_newstructure.service.runtime_lifecycle import shutdown_live_agents
...
class Runtime:
    ...
    async def reap(self, agent_id: str) -> None:
        await self._agents.reap(
            ...
            tasks=self._tasks,
            db=self.db,
            set_dead=dbmod.set_agent_status,
        )
