...
from murder_newstructure.orchestration.outcome import TicketOutcomeService
from murder_newstructure.tickets.status import TicketStatus

if TYPE_CHECKING:
    from murder.clients.base import APIClient
    from murder_newstructure.service.runtime_scope import AgentLifecycleHost as Runtime
