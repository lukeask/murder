...
Tiles render from :class:`~murder_newstructure.service.client_api.CrowSnapshot`
...
from murder_newstructure.service.client_api import CrowSessionSummary, CrowSnapshot
